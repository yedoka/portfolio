...
const ContactForm = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "d001f92f-c4b4-4096-8af0-f7bcd415013e");
      ...
      <div className="w-full md:w-1/2">
        ...
        <form onSubmit={onSubmit} className="flex flex-col w-full h-96 gap-4 rounded-md">
          <div className="flex flex-col w-full gap-2">
            ...
            <input name="name" type="text" placeholder="Enter your name" className="p-2 focus:outline-none rounded-sm" required />
          </div>
          <div className="flex flex-col w-full gap-2">
            <label>Email address</label>
            <input name="email" type="email" placeholder="Enter your email" className="p-2 focus:outline-none rounded-sm" required />
          </div>
          <div className="flex flex-col w-full gap-2">
            <label>Your message</label>
            <textarea name="message" placeholder="Enter your message" className="p-2 focus:outline-none rounded-sm" required></textarea>
          </div>
          <button type="submit" className="bg-teal-300 text-slate-950 w-36 py-2 rounded-sm hover:bg-teal-500 transition-colors duration-200">Send Message</button>
        </form>
      </div>
    </section>
  );
